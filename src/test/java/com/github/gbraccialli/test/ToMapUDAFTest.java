...
public class ToMapUDAFTest extends AbstractGenericUDAFResolver {

	static final Log LOG = LogFactory.getLog(ToMapUDAFTest.class.getName());
	...
	public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters)
		...
		return new UDAFDedupTimestampDuration();
	}

	public static class UDAFDedupTimestampDuration extends GenericUDAFEvaluator {
